...
def init_paths(base_dir=None, project_name=None):
    ...
    os.environ['TORCH_HOME'] = '/SSD_DISK/users/rongyi/.cache/torch/'
    os.environ['TRANSFORMERS_CACHE'] = '/SSD_DISK/users/rongyi/.cache/huggingface/hub/'
    os.environ['HUGGINGFACE_HUB_CACHE'] = '/SSD_DISK/users/rongyi/.cache/huggingface/hub/'
    os.environ['XDG_CACHE_HOME'] = '/SSD_DISK/users/rongyi/.cache/xdg/'
